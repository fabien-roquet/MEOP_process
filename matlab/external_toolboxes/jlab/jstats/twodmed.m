...
%
%   *|* drifters_med.png --- Median speed from the global drifter dataset.  
...
axes(h),ylabel('Median Speed (cm/s)')

if 0
    currentdir=pwd;
    cd([whichdir('jlab_license') '/figures'])
    print -dpng drifters_med
    crop drifters_med.png
    cd(currentdir)
end
