function[a]=morsea(varargin)
%MORSEA  Returns the generalized Morse wavelet amplitude "a".
%
%   MORSEA is a low-level function called by several of the Morse wavelet
%   functions.
%
...
%
%   A=MORSEA(K,GAMMA,BETA,'energy') returns the unit energy coefficient 
...
a2=morsea(ga,be,'test');
reporttest('MORSEA unit energy, alternate formulation', aresame(a,a2,1e-6));
