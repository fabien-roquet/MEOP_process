...
function[]=polysmooth_figures

disp('Example of polysmooth using Matlab''s ''Peaks'' function comparing constant, linear, and quadratic fits.')
...
%orient portrait
%print -dpng polysmooth_peaks_deviation.png
...
%orient portrait
%print -dpng polysmooth_peaks_scatter.png
