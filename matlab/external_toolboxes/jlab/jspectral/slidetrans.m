...
%The 2 pi's here are just to put the frequencies at the right places
%since this figure is left over from the days when I used to use cyclic
%frequency.  Yes I'm using radian frequency now.
figure
M=3000;
t=(0:M-1)';%t=t-M/2;
N=500;
