...
%   Type 'jhelp curvemoments' view this image. *|*
...
%aresame([Ixx -Ixy; -Ixy Iyy],jmat(theta)*[a2 0;0 b2]*jmat(-theta),1e-5)
%aresame([Ixx -Ixy; -Ixy Iyy],jmat(theta+pi/2)*[b2 0;0 a2]*jmat(-theta-pi/2),1e-5)
