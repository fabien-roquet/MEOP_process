...
function[]=psi2fields_fig
load qgsnapshot,use qgsnapshot
%Trouble assigning psi because of a function with that name... not my fault!
psi=qgsnapshot.psi;
...
for i=1:4
    ...
    %vlines([-1000 0]/1000,'k')
    %hlines([-2500 -1500]/1000,'k')
end

% %Same thing with tighter axes
% figure
% subplot(2,2,1),jpcolor(x,y,psi),title('Streamfunction')
% subplot(2,2,2),jpcolor(x,y,zeta),title('Vorticity')
% subplot(2,2,3),jpcolor(x,y,P),title('Okubo-Weiss')
