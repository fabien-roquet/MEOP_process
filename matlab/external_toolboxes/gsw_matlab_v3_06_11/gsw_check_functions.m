...
if exist('tomlabVersion') == 2
    ...
    fprintf(1,' \n');
    fprintf(1,'It appears that you have TOMLAB CPLEX optimisation solver installed. \n');
    
elseif exist('cplexqp.p') == 6
    
    fprintf(1,' \n');
    fprintf(1,'It appears that you have an IBM CPLEX optimisation solver installed. \n');
        
elseif (license('checkout', 'Optimization_Toolbox') == 1 & datenum(matlab_release_date) < 736574)
    
    fprintf(1,' \n');
    fprintf(1,'It appears that you have the Matlab optimisation toolbox installed. \n');
    
else
    
    fprintf(1,' \n');
    fprintf(1,'It appears that you do not have an suitable optimisation solver installed. \n');
    fprintf(1,'You do not have access to all of the functions contained in the toolbox. \n');
    fprintf(1,'We recommend TOMLAB CPLEX, however, IBM CPLEX is a suitable alternative \n');
    fprintf(1,'for your version of Matlab. \n');
