...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--update_config_files", action="store_true", help="Optionally sync JSON config files into data/config_files.")
    parser.add_argument("--import_data", action="store_true", help="Prepare raw ODV data staged under data/raw_smru_data_odv.")
